...
(function (exports) {
    ...
    function createDateColumn($wrapper, date, events) {
        ...
        /** filtrar los servicios de secretario*/
        if ((GlobalVariables.user.role_slug === 'secretary') && (filterProviderIds > 0)) {
            providers = GlobalVariables.availableProviders.filter(function (provider)
        {
            var servedServiceIds = provider.services.filter(function (serviceId) {
                var matches = filterServiceIds.filter(function (filterServiceId) {
                    return Number(serviceId) === Number(filterServiceId);
                        ...
                        'html': [
                            ...
                            $('<button/>', {
                                ...
                                'html': [
                                    ...
                                    $('<span/>', {
                                        'text': 'EALang.delete_appointment'
                                    })
                                ]
                            }),
                            $('<button/>', {
